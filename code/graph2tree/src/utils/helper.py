...
def load_checkpoint(
    ...
    predict_optimizer=None,
    generate_optimizer=None,
    merge_optimizer=None,
    embedding_scheduler=None,
    encoder_scheduler=None,
    predict_scheduler=None,
    ...
    if mode == "train":
        embedding_optimizer.load_state_dict(
        ...
        embedding_scheduler.load_state_dict(
            checkpoint["embedding_scheduler_state_dict"]
        )
    ...
    logger.info(
        "Successfully Loaded Checkpoint from {}, with epoch number: {} for {}".format(
            ckpt_path, start_epoch, mode
        )
    )
