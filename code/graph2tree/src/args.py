...
def build_parser():
    ...
    parser.add_argument(
        "-embedding_size", type=int, default=768, help="Embedding dimensions of inputs"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "-depth", type=int, default=2, help="Number of layers in each encoder"
    )
    ...
    parser.add_argument(
        "-epochs", type=int, default=70, help="Maximum # of training epochs"
    )
    parser.add_argument(
        "-dropout",
        type=float,
    ...
    parser.add_argument(
        "-len_generate_nums", type=int, default=0, help="store length of generate_nums"
    )
